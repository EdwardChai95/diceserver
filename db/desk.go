...
func UpdateNewDesk(d *model.Desk) error {
	_, err := database.Exec("UPDATE `desk` SET `player0` = ?, `player1` = ?, `player2` = ?, `player3` = ?, `player4` = ?, `player_name0` = ?, `player_name1` = ?, `player_name2` = ?, `player_name3` = ?, `player_name4` = ? WHERE `desk_no` = ? ",
		d.Player0,
		d.Player1,
		d.Player2,
		d.Player3,
